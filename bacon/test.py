...
def test_tiny_01():
    #Test, different actors who have acted together
    actor1 = 2876
    actor2 = 1532
    assert lab.acted_together(db_tiny, actor1, actor2) is True

def test_tiny_02():
    #Test, different actors who have not acted together
    actor1 = 1532
    actor2 = 1640
    assert lab.acted_together(db_tiny, actor1, actor2) is False

def test_tiny_bacon_number_0():
    #Test for how many actors in tiny db have bacon number of 0
    assert(lab.actors_with_bacon_number(db_tiny, 0)) == {4724}

def test_tiny_bacon_number_1():
    #Test for how many actors in tiny db have bacon number of 1
    assert(lab.actors_with_bacon_number(db_tiny, 1)) == {2876, 1532}

def test_tiny_bacon_number_2():
    #Test for how many actors in tiny db have bacon number of 2
    assert(lab.actors_with_bacon_number(db_tiny, 2)) == {1640}

def test_tiny_bacon_number_3():
    #Test for how many actors in tiny db have bacon number of 3
...
def test_tiny_bacon_path():
    # Bacon path from 4724 to 1640, tiny database
    actor_id = 1640
...
def test_tiny_movie_path():
    movie1 = 31932
    movie2 = 74881
    expected = ([2876, 1640], [4724, 1640], [1532, 1640])
    result = lab.actors_connecting_films(db_tiny, movie1, movie2)
    assert expected[0] == result or expected[1] == result or expected[2] == result
